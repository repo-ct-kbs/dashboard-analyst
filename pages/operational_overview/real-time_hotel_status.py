...
with option_col[0]:
    selected_filter = st.selectbox('Select Range', ['Weekly', 'Monthly', 'Yearly'])
with option_col[1]:
    if selected_filter == 'Weekly':
        ...
        fig = px.bar(week_occupancy_counts_df, 
                    x='week_number', 
                    y='occupancy_count', 
    ...
    if selected_filter == 'Monthly':
        ...
        fig = px.bar(month_occupancy_counts, 
                    x='month_name', 
                    y='occupancy_count', 
    ...
    if selected_filter == 'Yearly':
        ...
        fig = px.bar(year_occupancy_counts, 
                    x='year', 
                    y='occupancy_count', 
